...
namespace NFTGCO.Helpers.Editor
{
    ...
    public class InspectorButtonDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            {
                InspectorButton button = GetObjectForProperty(property) as InspectorButton;
                if (button == null)
                {
                    Debug.LogError("Unable to resolve InspectorButton from property " + property.propertyPath);
                    return;
                }
