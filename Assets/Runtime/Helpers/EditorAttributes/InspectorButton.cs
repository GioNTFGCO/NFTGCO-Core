...
{
    /// <summary>
    /// InspectorButton can be placed in any MonoBehaviour, ScriptableObject,
    /// StateMachineBehaviour or Serializable type to draw a button in the
    /// inspector with a custom callback. 
    /// Usage
    
    /// Normal button
    /// public NFTGCO.Helpers.InspectorButton NormalButton = new NFTGCO.Helpers.InspectorButton("MethodName");
    
    /// Action button
    /// public NFTGCO.Helpers.InspectorButton DelegateButton = new NFTGCO.Helpers.InspectorButton(input =>
    /// {
    ///     ScriptName demo = input as ScriptName;
    ...
    public class InspectorButton
    {
        ...
        /// that this InspectorButton is contained in. 
        /// </summary>
        ...
        public InspectorButton(string functionName, params object[] functionArgs)
        {
        ...
        /// </param>
        public InspectorButton(Action<object> action)
        {
            this.action = action;
