...
namespace NFTGCO.Helpers
{
    ...
    public class UDictionary<TKey, TValue> : UDictionary, IDictionary<TKey, TValue>
    {
        ...
        /// <summary>
        /// Gets Dictionary from cache, if it exists
        /// </summary>
        ...
        /// <summary>
        /// Gets a dictionary creating new dictionary cache.
        /// Use .Dictionary for a performant version.
        /// </summary>
        public Dictionary<TKey, TValue> FreshDictionary
        {
            get
            {
        ...
        public UDictionary(Dictionary<TKey, TValue> toCopy)
        {
            values = new List<TValue>(toCopy.Values);
            keys = new List<TKey>(toCopy.Keys);
            cache = null;
        }
    }
}